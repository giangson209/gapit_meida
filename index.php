...
<main>
    ...
    <section class="box-whoareyou">
        <div class="container">
            <div class="title text-center mb-0">
                <div class="title-desc">
                    WHO ARE WE? <span>a Marketing Agency</span>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="item-number" id="counter-box">
                            <div class="numb-top"><span class="counter" data-number="70"></span>
                                <label>
                                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.4664 15.5334C16.0997 13.6501 13.9164 12.4167 11.3998 12.4167C7.21644 12.4167 3.81641 15.8167 3.81641 20.0001C3.81641 24.1834 7.21644 27.5834 11.3998 27.5834C14.2164 27.5834 16.8331 26.1001 18.2831 23.6834L20.4998 20.0001L22.6998 16.3167C24.1498 13.9 26.7664 12.4167 29.5831 12.4167C33.7664 12.4167 37.1664 15.8167 37.1664 20.0001C37.1664 24.1834 33.7664 27.5834 29.5831 27.5834C27.0831 27.5834 24.8998 26.35 23.5164 24.4667" stroke="#F05225" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </label>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="item-number" id="counter-box">
                            <div class="numb-top"><span class="counter" data-number="2014"></span>
                                <label>
                                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.4664 15.5334C16.0997 13.6501 13.9164 12.4167 11.3998 12.4167C7.21644 12.4167 3.81641 15.8167 3.81641 20.0001C3.81641 24.1834 7.21644 27.5834 11.3998 27.5834C14.2164 27.5834 16.8331 26.1001 18.2831 23.6834L20.4998 20.0001L22.6998 16.3167C24.1498 13.9 26.7664 12.4167 29.5831 12.4167C33.7664 12.4167 37.1664 15.8167 37.1664 20.0001C37.1664 24.1834 33.7664 27.5834 29.5831 27.5834C27.0831 27.5834 24.8998 26.35 23.5164 24.4667" stroke="#F05225" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                    ...
                    <div class="col-md-3">
                        <div class="item-number" id="counter-box">
                            <div class="numb-top"><span class="counter" data-number="10"></span>
                                <label>
                                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.4664 15.5334C16.0997 13.6501 13.9164 12.4167 11.3998 12.4167C7.21644 12.4167 3.81641 15.8167 3.81641 20.0001C3.81641 24.1834 7.21644 27.5834 11.3998 27.5834C14.2164 27.5834 16.8331 26.1001 18.2831 23.6834L20.4998 20.0001L22.6998 16.3167C24.1498 13.9 26.7664 12.4167 29.5831 12.4167C33.7664 12.4167 37.1664 15.8167 37.1664 20.0001C37.1664 24.1834 33.7664 27.5834 29.5831 27.5834C27.0831 27.5834 24.8998 26.35 23.5164 24.4667" stroke="#F05225" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                    ...
                    <div class="col-md-3">
                        <div class="item-number" id="counter-box">
                            <div class="numb-top"><span class="counter" data-number="500"></span>
                                <label>
                                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.4664 15.5334C16.0997 13.6501 13.9164 12.4167 11.3998 12.4167C7.21644 12.4167 3.81641 15.8167 3.81641 20.0001C3.81641 24.1834 7.21644 27.5834 11.3998 27.5834C14.2164 27.5834 16.8331 26.1001 18.2831 23.6834L20.4998 20.0001L22.6998 16.3167C24.1498 13.9 26.7664 12.4167 29.5831 12.4167C33.7664 12.4167 37.1664 15.8167 37.1664 20.0001C37.1664 24.1834 33.7664 27.5834 29.5831 27.5834C27.0831 27.5834 24.8998 26.35 23.5164 24.4667" stroke="#F05225" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
    ...
    <section class="box-works">
        ...
        <div class="gsap-line-text">
            <div class="line-text-scroll">
                <span>Make Your Greater Impact</span>
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M38.4478 21C38.4478 26.7925 33.7403 31.5 27.9478 31.5C26.4613 31.5 25.0393 31.1908 23.7591 30.6278C23.447 30.4905 23.3882 30.083 23.6203 29.8333C25.8364 27.4501 27.0728 24.3014 27.0728 21C27.0728 17.6855 25.8236 14.5233 23.6237 12.1672C23.3904 11.9175 23.4488 11.5086 23.7616 11.3711C25.0412 10.8088 26.4623 10.5 27.9478 10.5C33.7403 10.5 38.4478 15.2075 38.4478 21Z" fill="#F05225"/>
                    <path d="M24.4478 21C24.4478 24.0975 23.1003 26.8975 20.9478 28.805C19.0928 30.485 16.6428 31.5 13.9478 31.5C8.15525 31.5 3.44775 26.7925 3.44775 21C3.44775 15.2075 8.15525 10.5 13.9478 10.5C16.6428 10.5 19.0928 11.515 20.9478 13.195C23.1003 15.1025 24.4478 17.9025 24.4478 21Z" fill="#F05225"/>
                </svg>
                <span>Make Your Greater Impact</span>
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M38.4478 21C38.4478 26.7925 33.7403 31.5 27.9478 31.5C26.4613 31.5 25.0393 31.1908 23.7591 30.6278C23.447 30.4905 23.3882 30.083 23.6203 29.8333C25.8364 27.4501 27.0728 24.3014 27.0728 21C27.0728 17.6855 25.8236 14.5233 23.6237 12.1672C23.3904 11.9175 23.4488 11.5086 23.7616 11.3711C25.0412 10.8088 26.4623 10.5 27.9478 10.5C33.7403 10.5 38.4478 15.2075 38.4478 21Z" fill="#F05225"/>
        ...
        <div class="container">
            ...
            <div class="list-partner">
                <div class="slide-partner">
                    <?php
                    for ($totl = 1; $totl <= 12; $totl++) { ?>
                        <div class="item-slide">
                            <?php
                            for ($x = 1; $x <= 4; $x++) { ?>
                                <div class="item-partner">
                                    <div class="logo-part"><img src="images/home/part-<?php echo $x ?>.png" class="img-fluid" alt=""></div>
                                </div>
                            <?php }
                            ?>
                        </div>
    ...
    <section class="box-dont-miss">
        <div class="content-miss">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="avarta"><img src="images/home/miss.png" class="img-fluid w-100" alt=""></div>
                    </div>
                    <div class="col-md-6">
                        <div class="txt-miss">
                            <div class="head-miss">Don’t <span>miss out</span></div>
                            <div class="desc">Get fresh tips, how-tos, and expert marketing advice every week. (14,500 people already are in this topics)</div>
                            <div class="form-miss">
                                <input type="text" placeholder="Enter your email address" class="txt_field">
                ...
                <div class="slide-article">
                    <div class="item-slide">
                        <div class="item-article">
                            <div class="avarta">
                                <div class="avr">
                                    <a href=""><img src="images/home/ar1.png" class="img-fluid w-100" alt=""></a>
                                </div>
                            </div>
                            <div class="info">
                    ...
                    <div class="item-slide">
                        <div class="item-article">
                            <div class="avarta">
                                <div class="avr">
                                    <a href=""><img src="images/home/ar2.png" class="img-fluid w-100" alt=""></a>
                                </div>
                            </div>
                            <div class="info">
                                <h3><a href="">10 SaaS Campaign Examples We Love + Tips to Steal Their Ideas</a></h3>
                    ...
                    <div class="item-slide">
                        <div class="item-article">
                            <div class="avarta">
                                <div class="avr">
                                    <a href=""><img src="images/home/ar3.png" class="img-fluid w-100" alt=""></a>
                                </div>
                            </div>
                            <div class="info">
                                <h3><a href="">10 SaaS Campaign Examples We Love + Tips to Steal Their Ideas</a></h3>
